    ...
    var e = {
        4567: function (e, t, i) {
                    ...
                    for (let t = 0; t < c; t++) if (-1 !== d || s.hasContent(t)) {
                        ...
                        if (_ || -1 !== d && t === c - 1) {
                            ...
                            if (s) {
                                ...
                                n || r.push({
                                    text: s, range: i, activate: (e, t) => o ? o.activate(e, t, i) : h(0, t), hover: (e, t) => {
                                        var s;
            ...
            t.NULL_COLOR = {css: "#00000000", rgba: 0}, function (e) {
                ...
                function t(e, t) {
                    return a = Math.round(255 * t), [r, n, o] = _.toChannels(e.rgba), {css: h.toCss(r, n, o, a), rgba: h.toRgba(r, n, o, a)}
                }
